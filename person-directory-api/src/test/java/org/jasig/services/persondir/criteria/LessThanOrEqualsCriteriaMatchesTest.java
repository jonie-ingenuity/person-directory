...
public class LessThanOrEqualsCriteriaMatchesTest {
    @Test(expected=IllegalArgumentException.class)
    public void testLessThanNullCriteria() {
        new LessThanOrEqualsCriteria("attr", null);
    }
    
    @Test
    public void testLessThanNumberCriteria() {
        Criteria c = new LessThanOrEqualsCriteria("attr", 31);
        ...
        c = new LessThanOrEqualsCriteria("attr", "31");
    ...
    public void testLessThanDateCriteria() {
        ...
        Criteria c = new LessThanOrEqualsCriteria("attr", new Date(date));
        ...
        c = new LessThanOrEqualsCriteria("attr", date);
